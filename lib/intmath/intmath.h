...
extern int IMDec2Int(char *,Word, bool);
extern long IMDec2Long(char *, Word, bool);
...
extern void IMInt2Dec(int,char *,Word, bool);
extern void IMInt2Hex(Word, char *, Word);
extern void IMLong2Dec(long,char *, Word, bool);
