...
static constexpr uint32_t TM_INF = UINT32_MAX;
static constexpr state_t* NULL_STATE =  nullptr;


state_t states[NUMSTATES] = {    
    state_t{Spr(rSPR_HEALTHBONUS, 0),               TM_INF, NO_PSP_ACTION,      NULL_STATE},                // S_NULL - Dummy entry
    ...
    state_t{Spr(rSPR_OURHERO,0),TM_INF,NO_MOBJ_ACTION,NULL_STATE},   // S_PLAY
    ...
    state_t{Spr(rSPR_OURHEROBDY,0),TM_INF,NO_MOBJ_ACTION,NULL_STATE},    // S_PLAY_DIE7
    ...
    state_t{Spr(rSPR_OURHEROBDY,1),TM_INF,NO_MOBJ_ACTION,NULL_STATE},    // S_PLAY_XDIE9
    ...
    state_t{Spr(rSPR_ZOMBIEBODY,0),TM_INF,NO_MOBJ_ACTION,NULL_STATE},    // S_POSS_DIE5
    ...
    state_t{Spr(rSPR_ZOMBIEBODY,1),TM_INF,NO_MOBJ_ACTION,NULL_STATE},    // S_POSS_XDIE9
    ...
    state_t{Spr(rSPR_SHOTGUY,11),TM_INF,NO_MOBJ_ACTION,NULL_STATE},  // S_SPOS_DIE5
    ...
    state_t{Spr(rSPR_SHOTGUY,20),TM_INF,NO_MOBJ_ACTION,NULL_STATE},  // S_SPOS_XDIE9
    ...
    state_t{Spr(rSPR_IMP,12),TM_INF,NO_MOBJ_ACTION,NULL_STATE},  // S_TROO_DIE5
    ...
    state_t{Spr(rSPR_IMP,20),TM_INF,NO_MOBJ_ACTION,NULL_STATE},  // S_TROO_XDIE8
    ...
    state_t{Spr(rSPR_DEMON,13),TM_INF,NO_MOBJ_ACTION,NULL_STATE},    // S_SARG_DIE6
    ...
    state_t{Spr(rSPR_CACOBDY,0),TM_INF,NO_MOBJ_ACTION,NULL_STATE},   // S_HEAD_DIE6
    ...
    state_t{Spr(rSPR_BARONBDY,0),TM_INF,A_BossDeath,NULL_STATE},    // S_BOSS_DIE7
    ...
    state_t{Spr(rSPR_STIMPACK,0),TM_INF,NO_MOBJ_ACTION,NULL_STATE},  // S_STIM
    state_t{Spr(rSPR_MEDIKIT,0),TM_INF,NO_MOBJ_ACTION,NULL_STATE},   // S_MEDI
    ...
    state_t{Spr(rSPR_BERZERKER,0|FF_FULLBRIGHT),TM_INF,NO_MOBJ_ACTION,NULL_STATE},   // S_PSTR
    ...
    state_t{Spr(rSPR_RADIATIONSUIT,0|FF_FULLBRIGHT),TM_INF,NO_MOBJ_ACTION,NULL_STATE},   // S_SUIT
    ...
    state_t{Spr(rSPR_CLIP,0),TM_INF,NO_MOBJ_ACTION,NULL_STATE},  // S_CLIP
    state_t{Spr(rSPR_BOXAMMO,0),TM_INF,NO_MOBJ_ACTION,NULL_STATE},   // S_AMMO
    state_t{Spr(rSPR_ROCKET,0),TM_INF,NO_MOBJ_ACTION,NULL_STATE},    // S_ROCK
    state_t{Spr(rSPR_BOXROCKETS,0),TM_INF,NO_MOBJ_ACTION,NULL_STATE},    // S_BROK
    state_t{Spr(rSPR_CELL,0),TM_INF,NO_MOBJ_ACTION,NULL_STATE},  // S_CELL
    state_t{Spr(rSPR_CELLPACK,0),TM_INF,NO_MOBJ_ACTION,NULL_STATE},  // S_CELP
    state_t{Spr(rSPR_SHELLS,0),TM_INF,NO_MOBJ_ACTION,NULL_STATE},    // S_SHEL
    state_t{Spr(rSPR_BOXSHELLS,0),TM_INF,NO_MOBJ_ACTION,NULL_STATE}, // S_SBOX
    state_t{Spr(rSPR_BACKPACK,0),TM_INF,NO_MOBJ_ACTION,NULL_STATE},  // S_BPAK
    state_t{Spr(rSPR_BFG9000,0),TM_INF,NO_MOBJ_ACTION,NULL_STATE},   // S_BFUG
    state_t{Spr(rSPR_CHAINGUN,0),TM_INF,NO_MOBJ_ACTION,NULL_STATE},  // S_MGUN
    state_t{Spr(rSPR_CHAINSAW,0),TM_INF,NO_MOBJ_ACTION,NULL_STATE},  // S_CSAW
    state_t{Spr(rSPR_ROCKETLAUNCHER,0),TM_INF,NO_MOBJ_ACTION,NULL_STATE},    // S_LAUN
    state_t{Spr(rSPR_PLASMARIFLE,0),TM_INF,NO_MOBJ_ACTION,NULL_STATE},   // S_PLAS
    state_t{Spr(rSPR_SHOTGUN,0),TM_INF,NO_MOBJ_ACTION,NULL_STATE},   // S_SHOT
    state_t{Spr(rSPR_LIGHTCOLUMN,0|FF_FULLBRIGHT),TM_INF,NO_MOBJ_ACTION,NULL_STATE}, // S_COLU
    state_t{Spr(rSPR_SMALLSTAL,0),TM_INF,NO_MOBJ_ACTION,NULL_STATE}, // S_STALAG
    state_t{Spr(rSPR_OURHERO,13),TM_INF,NO_MOBJ_ACTION,NULL_STATE},  // S_DEADTORSO
    state_t{Spr(rSPR_OURHERO,18),TM_INF,NO_MOBJ_ACTION,NULL_STATE},  // S_DEADBOTTOM
    state_t{Spr(rSPR_FIVESKULLPOLE,0),TM_INF,NO_MOBJ_ACTION,NULL_STATE}, // S_HEADSONSTICK
    state_t{Spr(rSPR_POOLBLOOD,0),TM_INF,NO_MOBJ_ACTION,NULL_STATE}, // S_GIBS
    state_t{Spr(rSPR_TALLSKULLPOLE,0),TM_INF,NO_MOBJ_ACTION,NULL_STATE}, // S_HEADONASTICK
    state_t{Spr(rSPR_BODYPOLE,0),TM_INF,NO_MOBJ_ACTION,NULL_STATE},  // S_DEADSTICK
    state_t{Spr(rSPR_HANGINGRUMP,0),TM_INF,NO_MOBJ_ACTION,NULL_STATE},   // S_MEAT5
    state_t{Spr(rSPR_LARGESTAL,0),TM_INF,NO_MOBJ_ACTION,NULL_STATE}, // S_STALAGTITE
    state_t{Spr(rSPR_SHORTGREENPILLAR,0),TM_INF,NO_MOBJ_ACTION,NULL_STATE},  // S_SHRTGRNCOL
    state_t{Spr(rSPR_SHORTREDPILLAR,0),TM_INF,NO_MOBJ_ACTION,NULL_STATE},    // S_SHRTREDCOL
    state_t{Spr(rSPR_CANDLE,0|FF_FULLBRIGHT),TM_INF,NO_MOBJ_ACTION,NULL_STATE},  // S_CANDLESTIK
    state_t{Spr(rSPR_CANDLEABRA,0|FF_FULLBRIGHT),TM_INF,NO_MOBJ_ACTION,NULL_STATE},  // S_CANDELABRA
    state_t{Spr(rSPR_MEDDEADTREE,0),TM_INF,NO_MOBJ_ACTION,NULL_STATE},   // S_TORCHTREE
    state_t{Spr(rSPR_TECHPILLAR,0),TM_INF,NO_MOBJ_ACTION,NULL_STATE},    // S_TECHPILLAR
